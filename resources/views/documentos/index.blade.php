             ...
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach ($data as $profesional)
                    ...
                    <tr class="gradeX">
                        ...
                        <a href="{{ url('admin/profesionales/'.$profesional->id.'/edit')}}" type="button" rel="tooltip" title="Editar" class="btn btn-primary btn-sm btn-icon btn-circle"> <i class="fa fa-pen"></i></a>    
                        @endcan                    
                        </td>                       
                    </tr>
