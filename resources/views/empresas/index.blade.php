             ...
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach ($data as $empresas)
                    ...
                    <tr class="gradeX">
                        ...
                        <td>{{$empresas->tipo_doc}}</td>                
                        <td>{{$empresas->n_documento}}</td>                
                        <td>{{$empresas->nom_ciudad}}</td>                
                        ...
                        <td> 
                        @can('empresas.edit')
                        <a href="{{ url('admin/empresas/'.$empresas->id.'/edit')}}" type="button" rel="tooltip" title="Editar" class="btn btn-primary btn-sm btn-icon btn-circle"> <i class="fa fa-pen"></i></a>
                        @endcan      
                        </td>
                        @can('empresas.destroy')
                        <td> 
                            <form method="post" action="{{ url('admin/empresas/'.$empresas->id)}}">
                                @method('DELETE')
                                {{ csrf_field() }}
